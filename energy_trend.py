...
#Noramalise the data with scaling facotr like population or GDP
df4 = df1.copy()
...
plt.tight_layout()
plt.savefig("Boxplot to Visualize Outliers in Normalized Energy Data.png", dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig("Trend of Energy Consumption Over the Years by Country.png", dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig("Correlation Matrix of Energy Data.png", dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig("Top 10 Countries by Average Energy Consumption.png", dpi=300, bbox_inches='tight')
...
#Visualization for Ridge and Lasso
    ...
    plt.ylabel('Predicted Energy Consumption')
    plt.tight_layout()
    plt.savefig(f"energy_plot_{name.replace(' ', '_')}.png", dpi=300, bbox_inches='tight')
    

#check if the dataset follows perato principle
#remove world rows from country column
...
plt.grid()
plt.tight_layout()
plt.savefig("Cumulative Energy Consumption by Country.png", dpi=300, bbox_inches='tight')


#Lorenz curve and Gini coefficient using top 20 countries
...
cumulative_energy_percentage = cumulative_energy / cumulative_energy[-1]
...
# add gini coefficient to the plot
...
plt.grid()
plt.tight_layout()
plt.savefig("Lorenz Curve for Energy Consumption.png", dpi=300, bbox_inches='tight')
...
plt.grid()
plt.tight_layout()
plt.savefig("Gini Coefficient of Energy Consumption Over Time.png", dpi=300, bbox_inches='tight')
